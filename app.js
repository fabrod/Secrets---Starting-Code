...
app.post("/register", function(req, res){
    const newUser = new User ({
        ...
        password: md5(req.body.password)//reversible hash//password: req.body.password
    });
...
app.post("/login", function(req, res){
    ...
    const password = md5(req.body.password);  //without md5 req.body.password;
